      ...
      <section id="book" className="section-padding" style={{ background: "linear-gradient(180deg, #F7F3EA 0%, #F2EDDF 50%, #F7F3EA 100%)" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-6 sm:mt-8 text-center">
            <p
              className="font-lato text-xs sm:text-sm mb-4"
              style={{ color: "#2B2D31" }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-montserrat text-xs font-semibold tracking-widest uppercase px-6 py-3 inline-flex items-center justify-center gap-2"
              ...
              <a
                ...
                className="font-montserrat text-xs tracking-widest uppercase px-6 py-3 inline-flex items-center justify-center"
