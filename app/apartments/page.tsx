...
const apartment = {
  ...
  images: [
    ...
    "/images/Two Bedroom Apartment images/IMG-20260618-WA0039 (1).jpg",
    "/images/Two Bedroom Apartment images/IMG-20260618-WA0026 (1).jpg",
    "/images/Two Bedroom Apartment images/IMG-20260618-WA0023.jpg",
    "/images/Two Bedroom Apartment images/IMG-20260618-WA0018.jpg",
    "/images/Two Bedroom Apartment images/IMG-20260618-WA0016.jpg",
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex gap-4 flex-wrap">
                  ...
                  >
                    ...
                    />
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4 relative z-10" aria-hidden="true">
      ...
      <section className="section-padding" style={{ background: "linear-gradient(180deg, #17233A 0%, #1a2844 50%, #17233A 100%)" }}>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-5 justify-center">
          {[
            ...
            <div
              key={i}
              className={`group relative rounded-xl overflow-hidden transition-all duration-500 card-hover reveal-scale flex flex-col ${i === 4 ? "md:col-start-2" : ""}`}
              style={{
          ...
          >
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group/btn font-montserrat relative inline-flex items-center gap-2 px-6 py-2.5 transition-all duration-300 overflow-hidden"
                style={{
                  border: "1.5px solid rgba(197,164,109,0.50)",
              ...
              >
                ...
                />
                <span className="relative z-10 font-montserrat text-xs font-semibold tracking-[0.15em] uppercase btn-text-main transition-colors duration-500" style={{ color: "#C5A46D" }}>
                  Book Now
                </span>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 relative z-10 btn-text-main transition-colors duration-500" style={{ color: "#C5A46D" }}>
          ...
          <div className="mt-8 sm:mt-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              >
                ...
                />
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4 relative z-10" style={{ color: "#C5A46D" }}>
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22 6 12 13 2 6" />
                </svg>
                <span className="relative z-10 font-montserrat text-xs font-semibold tracking-widest uppercase btn-text-main transition-colors duration-500" style={{ color: "#C5A46D" }}>
