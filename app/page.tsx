    ...
    <>
      ...
      <section id="book" className="section-padding" style={{ background: "linear-gradient(180deg, #17233A 0%, #1a2844 50%, #17233A 100%)" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p
            className="font-lato text-sm sm:text-base mb-8 sm:mb-10 max-w-xl mx-auto"
            style={{ color: "rgba(255,255,255,0.65)" }}
          >
          ...
          <div className="mt-8 sm:mt-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="font-montserrat text-xs font-semibold tracking-widest uppercase px-6 py-3 inline-flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105"
                style={{ backgroundColor: "#25D366", color: "#FFFFFF", borderRadius: "0.375rem" }}
              >
